...
const FlightCard = ({
  ...
  return (
    <div
      ...
      style={{
        borderLeft: `4px solid ${airlineColors.border}`,
        backgroundColor: airlineColors.light
      }}
    >
      <div className="flight-card-header">
        <h3 style={{ color: airlineColors.primary }}>{flight.airline}</h3>
      ...
      <div className="flight-card-body">
        <div className="flight-section outbound-section">
          <div className="flight-section-header">
            <span className="flight-type-tag outbound">去程</span>
            <span className="flight-section-date">{formatDateTime(flight.outboundDeparture).date}</span>
          </div>
          <div className="flight-times">
            <div className="time-display">
              <span className="time-label">起飛</span>
              <div className="time-value">
                <span className="time-part">{formatDateTime(flight.outboundDeparture).time}</span>
              </div>
            </div>
            <div className="time-display">
              <span className="time-label">抵達</span>
              <div className="time-value">
                <span className="time-part">{formatDateTime(flight.outboundArrival).time}</span>
              </div>
            </div>
          </div>
        ...
        <div className="flight-section return-section">
          <div className="flight-section-header">
            <span className="flight-type-tag return">回程</span>
            <span className="flight-section-date">{formatDateTime(flight.returnDeparture).date}</span>
          </div>
          <div className="flight-times">
            <div className="time-display">
              <span className="time-label">起飛</span>
              <div className="time-value">
                <span className="time-part">{formatDateTime(flight.returnDeparture).time}</span>
              </div>
            </div>
            <div className="time-display">
              <span className="time-label">抵達</span>
              <div className="time-value">
                <span className="time-part">{formatDateTime(flight.returnArrival).time}</span>
              </div>
            </div>
          </div>
