...
const FlightCard = ({
  ...
  return (
    <div className={`flight-option-card ${isChecked ? 'selected' : ''} ${isDisabled ? 'disabled' : ''}`}>
      <div className="flight-option-header">
        <div className="flight-price-section">
          ...
          {showCheckbox && (
            <input
              type="checkbox"
              className="flight-confirm-checkbox"
              checked={isChecked}
      ...
      <div className="flight-option-times">
        <div className="flight-time-column outbound">
          <div className="flight-time-label outbound-label">去程</div>
        ...
        <div className="flight-time-column return">
          <div className="flight-time-label return-label">回程</div>
          <div className="time-row">
            <span className="time-label-compact">起飛</span>
            ...
            {comments.map((comment) => (
              <div key={comment.id} className="comment-item">
                <div className="comment-header">
                  ...
                  {!isReadOnly && currentUser && comment.userId === currentUser.uid && (
                    <button
